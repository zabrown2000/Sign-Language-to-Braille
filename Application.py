...
class Application:
    ...
    def __init__(self):
        #print(enchant.list_dicts(self))
        #self.hs = Hunspell('en_US')
        #lib = cdll.LoadLibrary('./lib.so')
        #lib.enchant.set_prefix_dir.restype = c_char_p
        #pathStr = lib.enchant.set_prefix_dir("C:\\Users\\zbrow\\Documents")
        #pathStr = bytes("C:\Program Files (x86)", encoding="ascii")
        #pathStr = c_char_p("C:\Users\zbrow\Documents")
        #enchant.set_prefix_dir(pathStr)
        #enchant.request_dict("en_US")
        #self.hs = enchant.Dict("en_US")
        #pathStr = "C:\Program Files (x86)\hunspell\share\hunspell"
        #self.hs = enchant.request_dict(tag="en_US")
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language To Braille")
        ...
        self.T.config(text = "Sign Language To Braille", font = ("Courier", 30, "bold"))
        ...
        if(self.ct[self.current_symbol] > 60):
            ...
            if self.current_symbol == 'blank':
                ...
                if self.blank_flag == 0:
                    ...
                    self.str += self.word
                    #do something with braille
                    #braille.collect_image(self.word)
                    self.word = ""
                ...
                self.blank_flag = 0
                braille.collect_image(self.current_symbol)
